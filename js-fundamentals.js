...
// default values 
const saySomething = (phrase1, phrase2 = 'bye') => {
...
// OOP
class Car {
    constructor(brand, color, price, weight) {
        this.brand = brand; 
        this.color = color; 
        this.price = price; 
        this.weight = weight; 
    ...
    crash() {
        console.log(`im crashing this ${this.brand}`)
    }
}

const porsche = new Car('Porsche', 'blue', 4000, 6000)

console.log(porsche.crash())
...
profile.set('name', 'Tony Kim')
profile.set('age', 99)
profile.set('address', 'pineapple st.')
